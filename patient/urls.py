...
urlpatterns = [
    ...
    path("patient/api/chat/translate/", views.chat_api_translate, name="chat_api_translate"),
    ...
    path("patient/appointments/<int:appointment_id>/appeal/", views.submit_payment_appeal, name="submit_payment_appeal"),
